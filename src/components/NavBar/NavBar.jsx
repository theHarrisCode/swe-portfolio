...
function NavBar() {
    return (
        <>
            ...
            <Disclosure as="nav" className="bg-gray-800 rounded-2xl shadow-2xl mt-6 border-black nav-bar flex justify-between ">
                <div className="text-white flex ">Darren Harris</div>
